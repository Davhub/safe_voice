...
class FirebaseTestService {
  ...
  static Future<bool> testFirestoreConnection() async {
    try {
      ...
      DocumentReference testDoc = _firestore
          .collection('test')
  ...
  static Future<bool> testStorageConnection() async {
    try {
      ...
      String testContent =
          'Firebase Storage connection test - ${DateTime.now()}';
      await testRef.putString(testContent);

      print('✅ Storage upload successful');

      // Download the test file
      String downloadedContent = await testRef.getData().then(
  ...
  static Future<bool> testReportSubmission() async {
    try {
      ...
      DocumentReference reportDoc = await _firestore
          .collection('reports')
          .add(testReport);
